...
DOMAIN_DATASETS = {
    "nyc_shootings": {
        ...
        "description": (
            "Practice SQL, Python, and dashboard analytics using shooting incident data. "
            "Includes date, time, borough, precinct, location, latitude, and longitude."
        ),
    ...
    "consumer_complaints": {
        ...
        "description": (
            "Practice financial analysis using consumer complaint records. "
    ...
    "finance_economics": {
        ...
        "description": (
            "Practice finance and macroeconomic analysis using market, inflation, unemployment, "
            "GDP, consumer confidence, commodities, and spending indicators."
        ),
    ...
    "heart_health": {
        ...
        "description": (
            "Practice healthcare analytics using survey data related to health, lifestyle, "
            "heart attack indicators, diabetes, smoking, BMI, sleep, and demographics."
        ),
    ...
    "pharma_sales_hourly": {
        ...
        "description": (
            "Practice time-series healthcare/pharmacy analytics using hourly drug sales categories."
        ),
    ...
    "student_grades": {
        ...
        "description": (
            ...
            "grade level, program indicators, ELL, SPED, migrant, and AVID fields."
        ),
    ...
    "education_career_success": {
        ...
        "description": (
            "Practice education and career outcome analytics using GPA, SAT score, field of study, "
            "internships, projects, certifications, job offers, salary, satisfaction, and job level."
        ),
    ...
    "online_retail": {
        ...
        "description": (
            "Practice retail analytics using invoice, quantity, unit price, and customer information."
        ),
    ...
    "adidas_sales": {
        ...
        "description": (
            "Practice retail and business analytics using Adidas sales by retailer, region, state, city, "
            "product, price, units sold, sales, profit, margin, and sales method."
        ),
